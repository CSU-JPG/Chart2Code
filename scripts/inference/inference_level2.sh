...
MODEL_IDENTIFIER="qwen2.5_level2_7B"
#    Examples: "qwen2.5_level2_7B", "qwen2.5_level2_72B", "InternVL_2.5_level2_8B", etc.

# 2. Select the model loading mode: "hub" or "local".
LOAD_SOURCE="local"

# 3. Input JSON data file.
JSON_FILENAME="level2.json"
...
PYTHON_SCRIPT_NAME="Inference/level2/srcs/${MODEL_IDENTIFIER}.py"
...
OUTPUT_BASE_DIR="${PROJECT_ROOT}/Inference/level2"
