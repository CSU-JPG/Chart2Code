...
MODEL_IDENTIFIER="qwen2.5_direct_7B"
#    Examples: "qwen2.5_direct_7B", "qwen2.5_direct_72B", etc.

# 2. Select the model loading mode: "hub" or "local".
LOAD_SOURCE="local"

# 3. Input JSON data file.
JSON_FILENAME="level1_direct.json"
...
PYTHON_SCRIPT_NAME="Inference/level1_direct/srcs/${MODEL_IDENTIFIER}.py"
...
OUTPUT_BASE_DIR="${PROJECT_ROOT}/Inference/level1_direct"
