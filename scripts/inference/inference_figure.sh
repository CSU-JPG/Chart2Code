...
MODEL_IDENTIFIER="qwen2.5_figure_7B"
#    Examples: "qwen2.5_figure_7B", "qwen2.5_figure_72B", "internvl_chat_v1.5", etc.

# 2. Select the model loading mode: "hub" or "local".
LOAD_SOURCE="local"

# 3. Input JSON data file.
JSON_FILENAME="level1_figure.json"
...
PYTHON_SCRIPT_NAME="Inference/level1_figure/srcs/${MODEL_IDENTIFIER}.py"
...
OUTPUT_BASE_DIR="${PROJECT_ROOT}/Inference/level1_figure"
