...
# (data and style) to generate Python code via the Gemini API, saves the result, and logs the process.
...
API_MODEL = 'gemini-2.5-pro' # Or any other compatible model name
# ===================================================================================
...
INFERENCE_PARAMS = {
    "temperature": 0.1,
    "max_tokens": 8192  # Adjusted for standard large context
}
...
def generate_code_for_image(data_image_path: str, style_image_path: str, task_instruction_text: str, client) -> str:
    """Generates code via an OpenAI-compatible API (like Gemini)."""
    try:
...
def main():
    # --- 1. Argument Parsing ---
    parser = argparse.ArgumentParser(description="Generate Python code from a JSON task file using a Gemini API.")
