...
# to generate Python code with the InternVL-3-8B model, saves the result, and logs the process.
...
HUB_MODEL_ID = "OpenGVLab/InternVL3-8B" # Example Hub ID

# 2. Path to the local model (for 'local' loading)
script_dir = os.path.dirname(os.path.abspath(__file__))
LOCAL_MODEL_PATH = os.path.abspath(os.path.join(script_dir, '..', '..', 'models', 'InternVL3-8B'))
# ===================================================================================
...
def main():
    # --- 1. Argument Parsing ---
    parser = argparse.ArgumentParser(description="Generate Python code from a JSON task file using InternVL-3-8B.")
