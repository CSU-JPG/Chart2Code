...
# (data and style) to generate Python code via the OpenAI/Claude API, saves the result, and logs the process.
...
API_MODEL = 'claude-4-sonnet'  # Or any other compatible model
# ===================================================================================
...
def generate_code_for_image(data_image_path: str, style_image_path: str, task_instruction_text: str, client, processor=None) -> str:
    """Generates code via the OpenAI API."""
    try:
...
def main():
    # --- 1. Argument Parsing ---
    parser = argparse.ArgumentParser(description="Generate Python code from a JSON task file using an OpenAI/Claude API.")
