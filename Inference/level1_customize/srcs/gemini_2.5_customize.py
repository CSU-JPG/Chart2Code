...
# uses the Gemini Pro API to generate Python code,
...
# 1. API Model Name
API_MODEL = 'gemini-2.5-pro' # Or any other compatible model
...
INFERENCE_PARAMS = {
    "temperature": 0.1,
    "max_tokens": 32768# Adjusted for API limits if necessary
}
...
**Data:**
{data_text}
Now, based on the instruction, the data, and the reference image, please generate the Python code. The output format must be strictly as follows:
