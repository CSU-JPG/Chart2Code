...
# uses the GLM-4V-9B model to generate Python code,
...
"""
        ...
        with torch.no_grad():
            output = model.generate(**inputs, **INFERENCE_PARAMS)
...
def main():
    ...
    try:
        ...
        succeeded_count = processed_count - failure_count if processed_count > failure_count else 0
        print(f"\n--- ✅ Batch processing complete ---")
        print(f"Logs: {LOG_CSV_PATH}")
        print(f"Succeeded: {succeeded_count} | Failed: {failure_count}")
