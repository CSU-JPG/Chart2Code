...
# uses a dynamically generated prompt with the InternVL2.5-8B model to generate Python code,
...
def split_model(model_name='InternVL2_5-8B'):
    """
...
def main():
    ...
    try:
        ...
        device_map = split_model(model_name='InternVL2_5-8B')
