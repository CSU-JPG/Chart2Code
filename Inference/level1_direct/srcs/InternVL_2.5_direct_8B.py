...
def main():
    ...
    parser = argparse.ArgumentParser(description="Generate Python code for images specified in a JSON file using the InternVL2_5-8B model.")
    ...
    print(f"Loading InternVL2_5-8B model and tokenizer from '{model_to_load}'...")
    try:
    ...
    try:
        ...
        print(f"\n--- ✅ Batch processing complete (Model: InternVL2_5-8B) ---")
