# This script reads a JSON file to get image paths, uses a predefined prompt template with the Qwen3-VL model
...
INFERENCE_PARAMS = {
    "temperature": 0.1,
    "top_p": 0.9,
    "max_new_tokens": 32768, # Was 8192, adjusted for consistency
    "do_sample": True
}
...
def generate_code_for_image(image_path: str) -> str:
    ...
    try:
        ...
        # 2. Prepare inputs using the simplified Qwen3-VL API
        ...
        # 4. Decode the output, trimming the input tokens
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Generate Python code for images specified in a JSON file using the Qwen3-VL-30B model.")
    ...
    print(f"Loading Qwen3-VL-30B model and processor from '{model_to_load}'...")
    try:
    ...
    try:
        ...
        print(f"\n--- ✅ Batch processing complete (Model: Qwen3-VL-30B) ---")
