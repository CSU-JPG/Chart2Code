# This script reads a JSON file to get image paths, uses a predefined prompt template with the Llava model
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Generate Python code for images specified in a JSON file using the Llava model.")
    ...
    print(f"Loading Llava model and processor from '{model_to_load}'...")
    try:
    ...
    try:
        ...
        print(f"\n--- ✅ Batch processing complete (Model: Llava) ---")
