...
# and edit instructions to generate Python code with the GLM-4V-9B model, saves the result, and logs the process.
...
def generate_code_for_image(image_path: str, instruction_text: str, model, tokenizer) -> str:
    """Generates code for a given image using edit instructions with GLM-4V."""
    try:
