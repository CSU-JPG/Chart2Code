...
# and edit instructions to generate Python code with the Qwen3-VL model, saves the result, and logs the process.
...
def main():
    ...
    print(f"Current device target: {DEVICE} (with device_map='balanced')")
    try:
