...
def main():
    ...
    try:
        # Note: The model name is hardcoded here as the split_model function depends on it.
        # This is acceptable as the script is tailored for this specific model family.
