...
# and edit instructions to generate Python code with the llava-onevision model, saves the result, and logs the process.
...
def generate_code_for_image(image_path: str, instruction_text: str, model, processor) -> str:
    """Generates code for a given image using edit instructions with Llava-Onevision."""
    try:
