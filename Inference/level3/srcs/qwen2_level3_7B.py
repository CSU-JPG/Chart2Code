# This script generates Python code for data visualization tasks using the Qwen2-VL model.
...
def main():
    # 1. Argument Parsing
    parser = argparse.ArgumentParser(description="Generate Python code from JSON tasks using Qwen2-VL.")
