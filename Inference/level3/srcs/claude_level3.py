...
# OPENAI_MODEL: The model identifier to use for generation (e.g., gpt-4o).
# ===================================================================================
...
def main():
    ...
    # The --load_source argument is accepted for compatibility with the shell script but is not used.
